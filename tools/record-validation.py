...
def validate_record(r, modules, zig_version):
    ...
    if r["source_files"] != expected or r["source_digest"] != actual_digest: raise ValueError(f"{name}: stale source digest; actual={actual_digest}; regenerate validation evidence")
