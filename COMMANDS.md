...
- `python3 tools/verify-riscv64-morphic-runtime.py --self-test`, `python3 tools/verify-freestanding-riscv64-morphic-runtime.py --self-test`, and `python3 tools/verify-freestanding-riscv64-supervisor-trap.py --self-test` run focused ELF-field, timeout, framing, trap-record, and failure-path regressions without QEMU.
