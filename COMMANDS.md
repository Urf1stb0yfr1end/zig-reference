...
- `python3 tools/verify-riscv64-morphic-runtime.py --self-test` and `python3 tools/verify-freestanding-riscv64-morphic-runtime.py --self-test` run focused field-parsing, timeout, and framing failure-path regressions without QEMU.
