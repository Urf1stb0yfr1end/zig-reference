...
Batch 25B executed both verifier modes successfully with Zig 0.14.0 and QEMU 8.2.2. Linux UAPI constants were checked from the installed kernel UAPI headers before implementation.
