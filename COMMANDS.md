...
| `zig build smoke` | Defined, pending | Runs named-import external consumer tests. May create compiler output. | `build.zig` |
| `zig build test` | Defined, pending | Runs contracts, unit tests, and smoke tests under Zig 0.14.0. | `build.zig` |
