...
test "initialization_cycle is repaired" {
    _ = try P.plan(.{ .total_memory = 24576, .page_size = 4096, .initialization_node_count = 1, .initialization_edges = &.{}, .device_state_bytes = 1, .post_seal_allocation = .forbidden });
}
