module.exports = {
  ...
  "module": {
    "id": "32",
    "canonicalName": "type-length-value-decoder",
    "displayName": "Type Length Value Decoder",
    "directory": "projects/32-type-length-value-decoder",
    "publicEntrypoint": "projects/32-type-length-value-decoder/src/type_length_value_decoder.zig",
    "detailsContract": "projects/32-type-length-value-decoder/details.json",
    "humanContract": "projects/32-type-length-value-decoder/DETAILS.md",
    "portContract": "projects/32-type-length-value-decoder/port.js"
  },
  "baseline": {
    "zigVersion": "0.14.0",
  ...
  "sourceInventory": {
    "implementationFiles": [
      "projects/32-type-length-value-decoder/src/type_length_value_decoder.zig"
    ],
    "publicEntrypoints": [
      "projects/32-type-length-value-decoder/src/type_length_value_decoder.zig"
    ],
    ...
    "externalSmokeTests": [
      "projects/32-type-length-value-decoder/tests/smoke_test.zig"
    ],
    "examples": [],
    "fixtures": [],
    "benchmarks": [],
    ...
    "contracts": [
      "projects/32-type-length-value-decoder/README.md",
      "projects/32-type-length-value-decoder/MASTERY.md",
      "projects/32-type-length-value-decoder/DETAILS.md",
      "projects/32-type-length-value-decoder/details.json",
      "projects/32-type-length-value-decoder/port.js"
    ]
  },
  "publicContract": {
    "publicSymbols": [
    ...
    "invariantsToPreserve": [
      "Preserve the documented type-length-value-decoder public behavior, boundaries, and failure semantics."
    ],
  ...
  "dependencies": {
    "repository": [
      ...
      },
      {
        ...
        "importName": "length-prefixed-binary-field",
        "symbolsUsed": [],
        "mustPortFirst": true,
        "reason": "The module imports this direct repository dependency in build.zig.",
        "guaranteesInherited": []
    ...
    "used": [
      {
        ...
        "files": [
          {
            "path": "projects/32-type-length-value-decoder/src/type_length_value_decoder.zig",
            "lines": [],
            "symbols": []
          }
        ],
      ...
      },
      {
        ...
        "files": [
          ...
          {
            "path": "projects/32-type-length-value-decoder/tests/smoke_test.zig",
            "lines": [],
            "symbols": []
          }
        ],
  ...
  "buildSystemUsage": {
    "unitTestStep": "test-type-length-value-decoder",
    "smokeTestStep": "smoke-type-length-value-decoder",
    "namedModuleImport": "type-length-value-decoder",
    "sourcePath": "projects/32-type-length-value-decoder/src/type_length_value_decoder.zig",
    ...
    "runArtifacts": [
      "test-type-length-value-decoder",
      "smoke-type-length-value-decoder"
    ],
    "systemCommands": [],
    "likelyPortingRisks": [
  ...
  "manualReviewRequired": [
    {
      ...
      "requiredTests": [
        "zig build test-type-length-value-decoder",
        "zig build smoke-type-length-value-decoder"
      ]
    }
  ],
  "semanticPortingRisks": [
    {
      "risk": "Preserve the documented type-length-value-decoder public behavior, boundaries, and failure semantics.",
  ...
  "sourceMap": {
    ...
    "symbolsToFiles": [
      {
        "symbol": "TlvDecoder",
        "file": "projects/32-type-length-value-decoder/src/type_length_value_decoder.zig"
      }
    ]
  },
  "history": {
