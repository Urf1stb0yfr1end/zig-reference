module.exports = {
  ...
  "module": {
    "id": "21",
    "canonicalName": "unit-safe-quantity",
    "displayName": "Unit Safe Quantity",
    "directory": "projects/21-unit-safe-quantity",
    "publicEntrypoint": "projects/21-unit-safe-quantity/src/unit_safe_quantity.zig",
    "detailsContract": "projects/21-unit-safe-quantity/details.json",
    "humanContract": "projects/21-unit-safe-quantity/DETAILS.md",
    "portContract": "projects/21-unit-safe-quantity/port.js"
  },
  "baseline": {
    "zigVersion": "0.14.0",
  ...
  "sourceInventory": {
    "implementationFiles": [
      "projects/21-unit-safe-quantity/src/unit_safe_quantity.zig"
    ],
    "publicEntrypoints": [
      "projects/21-unit-safe-quantity/src/unit_safe_quantity.zig"
    ],
    ...
    "externalSmokeTests": [
      "projects/21-unit-safe-quantity/tests/smoke_test.zig"
    ],
    "examples": [],
    "fixtures": [],
    "benchmarks": [],
    ...
    "contracts": [
      "projects/21-unit-safe-quantity/README.md",
      "projects/21-unit-safe-quantity/MASTERY.md",
      "projects/21-unit-safe-quantity/DETAILS.md",
      "projects/21-unit-safe-quantity/details.json",
      "projects/21-unit-safe-quantity/port.js"
    ]
  },
  "publicContract": {
    "publicSymbols": [
    ...
    "invariantsToPreserve": [
      "Preserve the documented unit-safe-quantity public behavior, boundaries, and failure semantics."
    ],
    ...
    "used": [
      {
        ...
        "files": [
          {
            "path": "projects/21-unit-safe-quantity/src/unit_safe_quantity.zig",
            "lines": [],
            "symbols": []
          }
        ],
  ...
  "buildSystemUsage": {
    "unitTestStep": "test-unit-safe-quantity",
    "smokeTestStep": "smoke-unit-safe-quantity",
    "namedModuleImport": "unit-safe-quantity",
    "sourcePath": "projects/21-unit-safe-quantity/src/unit_safe_quantity.zig",
    ...
    "runArtifacts": [
      "test-unit-safe-quantity",
      "smoke-unit-safe-quantity"
    ],
    "systemCommands": [],
    "likelyPortingRisks": [
  ...
  "manualReviewRequired": [
    {
      ...
      "requiredTests": [
        "zig build test-unit-safe-quantity",
        "zig build smoke-unit-safe-quantity"
      ]
    }
  ],
  "semanticPortingRisks": [
    {
      "risk": "Preserve the documented unit-safe-quantity public behavior, boundaries, and failure semantics.",
  ...
  "sourceMap": {
    ...
    "symbolsToFiles": [
      {
        "symbol": "Quantity",
        "file": "projects/21-unit-safe-quantity/src/unit_safe_quantity.zig"
      }
    ]
  },
  "history": {
